  ...
  "../../node_modules/payment/lib/index.js"(exports, module) {
    (function() {
      ...
      Payment = function() {
        ...
        Payment2.fns = {
          ...
          validateCardExpiry: function(month, year) {
            ...
            if (typeof month === "object" && "month" in month) {
              ...
              ref1 = Payment2.fns.cardExpiryVal(month), month = ref1.month, year = ref1.year;
            }
            if (!(month && year)) {
              return false;
            }
        ...
        Payment2.restrictNumeric = function(el) {
          QJ.on(el, "keypress", restrictNumeric);
          return QJ.on(el, "input", restrictNumeric);
        };
        Payment2.cardExpiryVal = function(el) {
          return Payment2.fns.cardExpiryVal(QJ.val(el));
        };
        Payment2.formatCardCVC = function(el) {
          Payment2.restrictNumeric(el);
          QJ.on(el, "keypress", restrictCVC);
          QJ.on(el, "input", restrictCVC);
          return el;
        };
        Payment2.formatCardExpiry = function(el) {
          var month, year;
          Payment2.restrictNumeric(el);
        ...
        Payment2.formatCardExpiryMultiple = function(month, year) {
        ...
        Payment2.formatCardNumber = function(el, maxLength) {
          Payment2.restrictNumeric(el);
        ...
        Payment2.getCardArray = function() {
          return cards;
        };
        Payment2.setCardArray = function(cardArray) {
          cards = cardArray;
          return true;
        };
        Payment2.addToCardArray = function(cardObject) {
          return cards.push(cardObject);
        };
        Payment2.removeFromCardArray = function(type) {
          var key, value;
          for (key in cards) {
            value = cards[key];
            if (value.type === type) {
